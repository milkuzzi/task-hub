...
export const ru = {
  translation: {
    ...
    forgotPassword: {
      ...
      description:
        "Введите электронную почту. Если учётная запись существует, мы отправим ссылку для установки нового пароля.",
      email: "Электронная почта",
      submit: "Отправить ссылку",
      submitting: "Отправка…",
      success:
        "Если учётная запись с таким адресом существует, ссылка для восстановления пароля отправлена на почту.",
